...
This package contains pybind11 for Python 3.
...
%{python3_sitearch}/%{name}-{{{git_last_tag}}}-py%{python3_version}.egg-info

%changelog
* Wed Nov 24 2021 Monty <xiphmont@gmail.com> - 2.8.2-pre_master
- Build all fixes from master.
